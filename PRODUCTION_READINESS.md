...
| DM-7 | No secondary indexes; point access is a single masked slot | Only one access path; no range scans on keys **[range scans FIXED — DM-7: kv_range; sorted index deferred]** | P2 | L | yes |
