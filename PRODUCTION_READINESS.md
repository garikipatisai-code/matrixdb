...
| DM-2 | No schema/catalog (tables, columns, types) | Can't model real data; everything is one fixed record shape | P0 | L | partial — DM-2 (named columns + introspection) + DM-3 (types) landed; named tables deferred |
