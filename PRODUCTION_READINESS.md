...
| DM-3 | Fixed 64-byte record / 32-byte payload; no variable-length or real types | No strings, no nullable, no real columns | P0 | L | partial — DM-3a-i: u32/int64/double columns + minimal string columns landed; full var-length/nullable + catalog integration deferred |
