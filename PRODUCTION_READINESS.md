...
| DM-3 | Fixed 64-byte record / 32-byte payload; no variable-length or real types | No strings, no nullable, no real columns | P0 | L | partial — DM-3a-j: u32/int64/double + minimal strings + nullable (U32 scalar) landed; full var-length/typed-null + catalog integration deferred |
